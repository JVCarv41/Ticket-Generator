...
const yearInput = document.getElementById("year"); // Obtém o campo de entrada do ano
...
function padWithZero(value) {
  // Converte o valor para número para lidar com strings como "01"
...
ticketForm.addEventListener("submit", function (event) {
  ...
  // Exibe o ingresso
  ticketDisplay.style.display = "flex"; // Mostra o ingresso
});